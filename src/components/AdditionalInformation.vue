    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <ul>
                    <li v-for="(spec,index) in getInfo.specifications" :key="index">{{ spec }}</li>
                </ul>
                <h4>Product Highlights</h4>
                <ul>
                    <li v-for="(spec,index) in getInfo.highlights" :key="index">{{ spec }}</li>
                </ul>
                <h4>Kit Content</h4>
                <ul>
                ...
                <img src="/frontend/img/other_images/additional_info.jpg" alt="" style="width: 100%;"/>
            </div>
        </div>
    </div>
</template>
...
export default {
            ...
            information:[
                {
                    ...
                    highlights:[
                        ...
                        'Various delicious flavours are available'
                    ],
                    kit:[
                ...
                },
                {
                    ...
                    highlights:[
                        '400mAh internal battery (non-rechargeable)',
                        '2ml pre-refilled juice with 2% nicotine strength',
                        '550 to 600 puffs',
                        'Draw activated',
                        'Multiple flavours for your selection',
                    ],
                    kit:[
                        '1 x Frunk Bar Disposable Pod Device 600 Puffs'
                    ]
                },
                {
                    name:'IVG Bar',
                    ...
                    highlights:[
                        ...
                        '2ml pre-refilled juice with 2% nicotine strength.',
                        'Large 500mAh inbuilt battery for 600 puffs.',
                        'Multiple flavours for your selection.',
                    ],
                    kit:[
                        '1 x IVG Bar Disposable Pod Device 600 Puffs.'
                    ]
                },
                {
                    name:'ELF Bar',
    ...
    computed:{
        getInfo(){
            return this.information.find((item) => item.name == this.name)
        }
    }
}
</script>
